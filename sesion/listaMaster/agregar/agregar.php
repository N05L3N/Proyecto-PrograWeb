<!DOCTYPE html>
	<html>
		...
		<body>
			...
			<form  class="contact_form" id="contact_form" action="validarRegistro.php" method="post">  
			        <div>  
			            ...
			            <ul>  
						 ...
						 <button id="cerrar"onClick="window.location.href='../../webMaster.php' ">Cancelar</button>
		</center>
