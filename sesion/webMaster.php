			...
			<div id = "contenedor">
				...
				<nav>
	                <ul >
	                    ...
	                    <li><a href="listaMaster/lista.php">Lista de Usuarios</a></li>
	                    <li><a href="listaMaster/agregar/agregar.php">Agregar Usuario</a></li>
	                    <li><a href="listaMaster/PeliAgr/Rentaswm.php">Peliculas</a></li>
	                </ul>
	            </nav>
